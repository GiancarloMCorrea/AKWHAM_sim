...
make_plot_traditional = function(om_toPlot, i, main_dir) {
  ...
  par(mar = c(2,4,1,1))
  plot(these_ages, om_toPlot$mat_at_age[1,], type = 'b', xlab = NULL, ylab = 'Maturity at age')
  par(mar = c(2,4,1,1))
  ...
  box()
  par(mar = c(2,4,1,1))
  matplot(om_toPlot$jan1LAA, type = 'l', ylab = 'Mean length at age (Jan 1st)', axes = FALSE)
  ...
  # Selectivity:
  par(mar = c(2,4,1,1))
  plot(these_ages, om_toPlot$selAA[[1]][1,], type = 'b', xlab = NULL, ylab = 'Sel at length (Fishery)', ylim = c(0,1))
  par(mar = c(2,4,1,1))
  plot(these_ages, om_toPlot$selAA[[2]][1,], type = 'b', xlab = NULL, ylab = 'Sel at length (Survey)', ylim = c(0,1))   
  dev.off()
...
make_plot_stepwise = function(om_toPlot, i, main_dir) {
  ...
  plot(these_years, om_toPlot$F[,1], type = 'b', xlab = NULL, ylab = 'F')
  par(mar = c(2,4,1,1))
  plot(these_lengths, om_toPlot$mat_at_len[1,], type = 'b', xlab = NULL, ylab = 'Maturity at length')
  par(mar = c(2,4,1,1))
  matplot(om_toPlot$ssb_phi_mat[,,1], type = 'l', ylab = 'SSB phi matrix (year 1)', axes = FALSE)
  axis(1, at = 1:length(these_lengths), labels = these_lengths)
  axis(2)
  ...
  # Selectivity:
  par(mar = c(2,4,1,1))
  plot(these_lengths, om_toPlot$selLL[[1]][1,], type = 'b', xlab = NULL, ylab = 'Sel at length (Fishery)', ylim = c(0,1))
  par(mar = c(2,4,1,1))
  plot(these_lengths, om_toPlot$selLL[[2]][1,], type = 'b', xlab = NULL, ylab = 'Sel at length (Survey)', ylim = c(0,1))   
